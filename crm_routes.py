...
# Import du générateur V2 COMPLET (version travaillée avec parcelles cadastrales)
from plan_masse_generator_v2 import generate_plan_masse as generate_plan_masse_screenshot
