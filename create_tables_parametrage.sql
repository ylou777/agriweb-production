...
-- Note: PostgreSQL ignore l'ALTER TABLE si la colonne existe déjà grâce au IF NOT EXISTS
ALTER TABLE parametrage_prix_organes ADD COLUMN IF NOT EXISTS description TEXT;
ALTER TABLE parametrage_prix_organes ADD COLUMN IF NOT EXISTS marque VARCHAR(100);
ALTER TABLE parametrage_prix_organes ADD COLUMN IF NOT EXISTS modele VARCHAR(100);
ALTER TABLE parametrage_prix_organes ADD COLUMN IF NOT EXISTS fournisseur VARCHAR(100);
ALTER TABLE parametrage_prix_organes ADD COLUMN IF NOT EXISTS reference_fournisseur VARCHAR(100);
