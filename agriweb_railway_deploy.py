...
def main():
    try:
        print("🌾 AgriWeb - Version Railway")
        print("📍 Démarrage sur Railway avec configuration cloud")
        
        # Configuration Railway : PORT variable et HOST 0.0.0.0
        import os
        ...
        app.run(host=HOST, port=PORT, debug=False)  # Configuration Railway
    except Exception as e:
        import traceback
        tb = traceback.format_exc()
...
# ============================================================================
# INTÉGRATION DES ROUTES CRM
# ============================================================================
# Importer et enregistrer toutes les routes CRM
